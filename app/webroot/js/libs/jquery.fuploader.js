 (function($) {
    $('.js-preview-close').livequery('click', function(e) {
        var $this = $(this);
...
/**
                ...
                uploaderReady: function() {
                    ...
                    if ($this.parent().find('.normal-uploader').length) {
                        preview_movie_id = (this.__movieid).substring(12);
                        ...
                        jQuery('#' + this._settings.containerID).after('<div class="clearAll" id="'+preview_movie_id+'"><a href="javascript://" class="clear" title="Delete ">&nbsp;</a></div>');
                ...
                fileUploadServerData: function(args) {
                    ...
                    if (serverData.substring(0, 7) === "FILEID:") {
                        if (this.__uPreview == '1') {
                            ...
                            $('#preview_image' + preview_movie_id).html('<img src="' + this._previewScript + '/' + file_id + '" ><input type="hidden" name="data[ProductPhoto][' + preview_movie_id + '][filename]" value="' + file_id + '">');							
							jQuery('.clearAll', $this).show();
