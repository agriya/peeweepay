...
<div>
    <div>
        <div>
            <h3><?php echo $html->link(__l('Cities'), array('action' => 'index'),array('title' => __l('Cities')));?> &raquo; <?php echo __l('Add Cities');?></h3>
        </div>
        <div>
            <?php echo $form->create('City', array('class' => 'normal','action'=>'add'));?>
            <?php
