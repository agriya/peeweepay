...
<div id="main">
    ...
    <?php if(!($this->params['controller'] == 'products' && ($this->params['action'] == 'add' || $this->params['action'] == 'v' || ($this->params['action'] == 'index' && (isset($this->params['named']['type']) && $this->params['named']['type'] == 'home'))))) : ?>
      </div>
        <div class="main-bl">
            <div class="main-br">
