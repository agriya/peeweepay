...
// rajesh_04ag02 // 2008-07
						...
						echo "\t\t<p><?php echo \$html->link(\$html->".$_wrapMethod."(\${$singularVar}['{$alias}']['{$details['displayField']}']), array('controller'=> '{$details['controller']}', 'action' => 'view', \${$singularVar}['{$alias}']['{$_slugName}']), array('escape' => false));?></p>\n";
						break;
					}
				}
			}
...
// rajesh_04ag02 // 2008-07
				...
				echo "\t\t<p><?php echo \$html->".$_wrapMethod."(\${$singularVar}['{$modelClass}']['{$field}']);?></p>\n";
			}
		}
