<?php
/* SVN FILE: $Id: error.php 254 2009-08-26 15:57:20Z rajesh_059at09 $ */
/**
 * Error handler
 *
 ...
 * @lastmodified  $Date: 2009-02-13 20:26:00 +0530 (Fri, 13 Feb 2009) $
 ...
 */
	function __construct($method, $messages) {
		...
		if ($method !== 'error') {
			if (Configure::read() == 0 && $method != 'error500' && $method != 'error403') {
				$method = 'error404';
...
// From Siva
    ...
    function error500()
    {
        ...
        $this->controller->set(array(
            'name' => __l('Temporarily Down for Maintenance') ,
            'base' => $this->controller->base,
            'title' => __l('Temporarily Down for Maintenance')
        ));
    ...
    function error403()
    {
        ...
        $this->controller->set(array(
            'name' => __l('Access forbidden') ,
            'base' => $this->controller->base,
            'title' => __l('Access forbidden')
        ));
