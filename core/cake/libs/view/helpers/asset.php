...
class AssetHelper extends Helper
{
    ...
    function scripts_for_layout()
    {
        ...
        $view->__scripts = array_merge(array_slice($view->__scripts, $this->viewScriptCount) , array_slice($view->__scripts, 0, $this->viewScriptCount));
        ...
        $scripts_for_layout = join("\n\t", $view->__scripts) . $scripts_for_layout;
