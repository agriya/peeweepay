<?php
/* SVN FILE: $Id: dbo_source.php 266 2009-08-28 17:33:24Z rajesh_059at09 $ */
/**
 ...
 * @lastmodified  $Date: 2009-02-16 02:35:42 +0530 (Mon, 16 Feb 2009) $
...
// rajesh_04ag02 // 2009-03-04 // Patch as otherwise, the sql is getting rewritten with added 'id' field when SUM is used.
// had to path for aggregatable behavior to work with for PSD2XHTML as Boopathi reported
				$match2 = strpos($passedFields[0], 'SUM(');
				if ($match === false && $match1 === false && $match2 === false) {
// <--
