...
class ImageUploadBehavior extends UploadBehavior
{
    function setup(&$model, $config = array())
    {
        ...
        $this->_is_use_imagick = class_exists('imagick');
    ...
    function original(&$model, $original, $destination)
    {
    ...
    function resize(&$model, $id = null, $width = 600, $height = 400, $writeTo = false, $aspect = true, $fullPath = null, $is_beyond_original = false)
    {
        if ($id === null && $model->id) {
            $id = $model->id;
        } elseif (!$id) {
    ...
    function resizeFile(&$model, $fullPath, $width = 600, $height = 400, $writeTo = false, $aspect = true, $is_beyond_original = false)
    {
        if (!$width || !$height) {
            return false;
        }
