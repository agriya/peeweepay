...
class SluggableBehavior extends ModelBehavior {
	...
	function setup(&$Model, $settings = array()) {
		$default = array('real' => true, 'label' => array('title'), 'slug' => 'slug', 'separator' => '-', 'length' => 100, 'overwrite' => true, 'translation' => null);
	...
	function __slug($string, $settings) {
		if (!empty($settings['translation']) && is_array($settings['translation'])) {
			...
			return $this->__slug($string, array_merge($settings, array('translation' => $translations[$settings['translation']])));
		}
