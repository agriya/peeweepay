<?php
/* SVN FILE: $Id: model.php 257 2009-08-26 15:59:27Z rajesh_059at09 $ */
/**
 ...
 * @lastmodified  $Date: 2009-02-11 09:23:04 +0530 (Wed, 11 Feb 2009) $
...
// rajesh_04ag02 // 2008-10-23 // restored to previous condition as Containable behavior is throwing error
            ...
            if ($sphinxSearch) {
                ...
                if (!empty($query['conditions'])) {
                    foreach($query['conditions'] as $key => $value) {
                        if (strtoupper($query['conditions'][$key]) == 'OR') {
