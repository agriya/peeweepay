<?php
/* SVN FILE: $Id: router.php 226 2009-05-23 10:04:20Z rajesh_04ag02 $ */
/**
 ...
 * @lastmodified  $Date: 2009-02-17 23:56:37 +0530 (Tue, 17 Feb 2009) $
...
// Was				if (isset($names[$key])) {
// Siva: trimming of "index" when named params next to it...
					if (isset($names[$key]) && strpos($found, $_this->named['separator']) === false) {
// <--
...
// Siva: Fixed named params got ignored
// Was					$out['named'] = $named;
						$out['named'] = array_merge($out['named'], $named);
// <--
					}
				}
...
// @todo Fails for /video/a:1/b:2
    	if ($out['controller']==Inflector::singularize($out['controller'])){
